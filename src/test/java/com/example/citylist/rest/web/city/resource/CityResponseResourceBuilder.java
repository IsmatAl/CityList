...
public class CityResponseResourceBuilder
        extends
        CityResponseResource.CityResponseResourceBuilder {

    public static CityResponseResource.CityResponseResourceBuilder designCityResponseResource() {
        return new CityResponseResource.CityResponseResourceBuilder().cityName("Tallinn").imageURL("http://example.com");
    }
